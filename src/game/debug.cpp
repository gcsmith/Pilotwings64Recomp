...
void pilotwings64::do_warp(int area, int scene, int entrance) {
    const pilotwings64::SceneWarps game_scene = pilotwings64::game_warps[area].scenes[scene];
...
void pilotwings64::set_time(uint8_t day, uint8_t hour, uint8_t minute) {
