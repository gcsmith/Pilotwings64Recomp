...
cp Pilotwings64Recompiled AppDir/usr/bin/
cp -r assets/ AppDir/usr/bin/
cp recompcontrollerdb.txt AppDir/usr/bin/
cp icons/512.png AppDir/Pilotwings64Recompiled.png
cp .github/linux/Pilotwings64Recompiled.desktop AppDir/

"./linuxdeploy-$LINUX_DEPLOY_ARCH.AppImage" --appimage-extract
mv squashfs-root/ deploy
./deploy/AppRun --appdir=AppDir/ -d AppDir/Pilotwings64Recompiled.desktop -i AppDir/Pilotwings64Recompiled.png -e AppDir/usr/bin/Pilotwings64Recompiled --plugin gtk
...
echo '    APP_FOLDER_PATH=$APP_FOLDER_PATH ./Pilotwings64Recompiled' >> AppDir/AppRun
echo 'else' >> AppDir/AppRun
echo '    cd "$this_dir"/usr/bin/' >> AppDir/AppRun
echo '    ./Pilotwings64Recompiled' >> AppDir/AppRun
